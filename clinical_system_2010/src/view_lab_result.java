 ...
 * @author gech
 */
public class view_lab_result extends javax.swing.JFrame {

    /**
     * Creates new form view_lab_result
     */
    public view_lab_result(String x, String y) {
        initComponents();
        display.setText(x);
        displayp.setText(y);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(displayp, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 160, 30));
        getContentPane().add(display, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 0, 169, 30));
        ...
        dsctp.add(cmd_print);
        cmd_print.setBounds(330, 30, 90, 40);
        ...
        jScrollPane1.setBounds(30, 80, 1010, 450);
        ...
        dsctp.add(jButton1);
        jButton1.setBounds(239, 30, 70, 40);
        dsctp.add(jPanel1);
        jPanel1.setBounds(10, 10, 1050, 540);

        getContentPane().add(dsctp, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 1070, 560));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rptyp.getSelectedItem().toString().equals("TYPE OF REPORT")) {
                ...
                fetch = hello.view_lab_result(rptyp.getSelectedItem().toString(), sex.getSelectedItem().toString());
                int c = fetch.length;
                int i = 0, j = 0, idx = 0,cc=0;
                   if (c >= 1) {
                
                
                 String report = (rptyp.getSelectedItem().toString() + "        " + sex.getSelectedItem().toString() + "   PATEINTS   LAB RESULT   REPORT   IN   UNIVERSITY   OF   GONDAR   ATSE   TEWODROSE   STUDENT  CLINIC   \n ");

                        String s = report + "\n add here the needed information\n    LAB ID" + "     " + "ID NUMBER" + "         " + "CARD NUMBER" + "        HISTORY ID" + "     " + "PATIENT NAME" + "            " + "SEX" + "         " + "DATE" + "        TIME" + "                       " + "LAB TEST" + "         " + "REMARK" + "         " + "REPORTER NAME" + "         " + "SERVIECE" + "                        " + "CALLED" + "               \n";
                    ...
                    JOptionPane.showMessageDialog(null, "LAB RESULT TABLE IS EMPTY",
                            null,
                            JOptionPane.PLAIN_MESSAGE);
                    txta.setText("");
                }
 ...
 else
 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_lab_result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_lab_result("", "").setVisible(true);
            }
        });
    }
