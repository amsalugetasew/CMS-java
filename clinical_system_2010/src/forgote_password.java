 ...
 * @author gech
 */
public class forgote_password extends javax.swing.JFrame {

    /**
     * Creates new form forgote_password
     */
    public forgote_password(String x,String y) {
        initComponents();
        display.setText(x);
          displayp.setText(y);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("FORGOTE PASSWORD");
        ...
        getContentPane().add(pfn, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 214, 245, 30));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(179, 211, 130, 30));

        jDesktopPane1.setBackground(new java.awt.Color(204, 204, 204));
        jDesktopPane1.add(jPanel1);
        jPanel1.setBounds(10, 10, 720, 500);

        getContentPane().add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 740, 520));
...
String password=null;
      ...
      // Logger.getLogger(CryptWithMD5.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(!pwn.getText().equals(cpw.getText()))
            {
            ...
            else
            {
                try
                {
                    ...
                    int count=(hello.forgot_password(ob.member_id,ob.user_nme,ob.profssion,password));
                    if(count>=1){
                        JOptionPane.showMessageDialog(null, "PASSWORD IS SUCESSESFULY RECOVERED",
                            null,
...
//                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(forgote_password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new forgote_password("","").setVisible(true);
            }
        });
    }
